const MockTheWayWePlay = {
  ...
  type: 'text',
  content: {
    html: 'Var: Hemma hos Emelie, Gustav och Nico Anaïs i deras vackra lägenhet på Upper East Side i New York.
  ...
  url: '/images/mock/twwp-4.jpg'
   ...
   type: 'text',
   content: {
     html: 'Hur var det när hon äntligen fick komma hem?
   ...
   type: 'text',
   content: {
     html: 'Största skillnaden med att bo i New York jämfört med Sverige?
  ...
  type: 'text',
  content: {
    html: 'What Goes Around Comes Around – Den bästa vintage butiken i NYC, hands down. Svindyrt men om så bara för span så är det värt att gå hit varje gång man är downtown för att bli inspirerad. Här finns allt från trashiga Guns N´Roses tishor till Hermés porslin.
   ...
   type: 'text',
   content: {
     html: 'Hur får man kärleken att hålla under småbarnsåren?
