      ...
      <div className='layout layout-front'>
          <Container fluid classes='panel-1'>
              <Row className='articles row-flex'>
                  <Col sm={12}>
                      <ParticleH2 className='text-color-gold header-top' {...this.props.data.field_particles_h2[17]}/>
                      <HR/>
                  </Col>
                  <Col sm={3}>
                  ...
                  <Col sm={3}>
                      <ParticleH2 className='heading-text' {...this.props.data.field_particles_h2[16]}/>
                  </Col>
              </Row>
          </Container>
          <Container fluid>
                  ...
                  <Col sm={6}>
                      <ArticleTeaser classes="wrapper lg-img">
                          ...
                          <Col sm={8} smOffset={3} className="article-meta-large meta-links has-intro-text">
                              <ArticleTeaser classes="wrapper" ArticleCategory={this.props.data.field_particles[5].field_main_topics[0]} ParticleH2={this.props.data.field_particles[5].ParticleH2} ParticleText={this.props.data.field_particles[5].ParticleText} ContributorList={this.props.data.field_particles_text[5].field_contributors}/>
                          </Col>
                      </ArticleTeaser>
                  </Col>
                  <Col sm={6}>
                      <ArticleTeaser classes="wrapper lg-img">
                          ...
                          <Col sm={8} smOffset={3} className="article-meta-large meta-links has-intro-text">
                              <ArticleTeaser classes="wrapper" ArticleCategory={this.props.data.field_particles[27].field_main_topics[0]} ParticleH2={this.props.data.field_particles[27].ParticleH2} ParticleText={this.props.data.field_particles[27].ParticleText} ContributorList={this.props.data.field_particles_text[27].field_contributors}/>
                          </Col>
                      </ArticleTeaser>
                  </Col>
              </Row>
          ...
          <Container fluid>
              <Row className='articles-grid row-flex'>
                  <Col xs={12} sm={6} md={4}>
                      <SquareArticleContainer>
                          <ParticleH2 className='text-color-gold' {...this.props.data.field_particles_h2[15]}/>
                          <HR/>
                  ...
                  <Col xs={12} sm={6} md={4}>
                      <ArticlesListContainer>
                          <ParticleH2 className='text-color-gold' {...this.props.data.field_particles_h2[18]}/>
                          <HR/>
                          <div className='articles-list-text'>
                              <ParticleText {...this.props.data.field_particles_text[8]}/>
                              <ParticleText {...this.props.data.field_particles_text[23]}/>
                              <ParticleText {...this.props.data.field_particles_text[24]}/>
                              <ParticleText {...this.props.data.field_particles_text[25]}/>
                  ...
                  <Col xs={12} sm={6} md={4}>
                      <SquareArticleContainer>
                          <ParticleH2 className='text-color-gold' {...this.props.data.field_particles_h2[19]}/>
                          <HR/>
                          <ParticleImage {...this.props.data.field_particles_image[7]}/>
              ...
              <Row className='contributors-grid'>
                  <Col sm={3}>
                      <AboutContributorContainer ParticleImage={this.props.data.field_particles[10].ParticleImage} ParticleH2={this.props.data.field_particles[10].ParticleH2} ParticleH3={this.props.data.field_particles[10].ParticleH3} ParticleText={this.props.data.field_particles_text[10].ParticleText}/>
                  </Col>
                  <Col sm={3}>
                      <AboutContributorContainer ParticleImage={this.props.data.field_particles[10].ParticleImage} ParticleH2={this.props.data.field_particles[10].ParticleH2} ParticleH3={this.props.data.field_particles[10].ParticleH3} ParticleText={this.props.data.field_particles_text[10].ParticleText}/>
                  </Col>
              ...
              <Row className='articles row-flex'>
                  <Col sm={6}>
                      <ArticleTeaser classes="wrapper lg-img">
                          <ParticleImage {...this.props.data.field_particles_image[32]}/>
                          <Col sm={8} smOffset={3} className="article-meta-large meta-links has-intro-text">
                              <ArticleTeaser classes="wrapper" ArticleCategory={this.props.data.field_particles[33].field_main_topics[0]} ParticleH2={this.props.data.field_particles[33].ParticleH2} ParticleText={this.props.data.field_particles[33].ParticleText} ContributorList={this.props.data.field_particles_text[33].field_contributors}/>
                          </Col>
                      </ArticleTeaser>
                  </Col>
                  <Col sm={6}>
                      <ArticleTeaser classes="wrapper lg-img">
                          <ParticleImage {...this.props.data.field_particles_image[34]}/>
                          <Col sm={8} smOffset={3} className="article-meta-large meta-links has-intro-text">
                              <ArticleTeaser classes="wrapper" ArticleCategory={this.props.data.field_particles[35].field_main_topics[0]} ParticleH2={this.props.data.field_particles[35].ParticleH2} ParticleText={this.props.data.field_particles[35].ParticleText} ContributorList={this.props.data.field_particles_text[35].field_contributors}/>
                          </Col>
                      </ArticleTeaser>
                  </Col>
                  <Col sm={9}>
                      <WideImgContainer>
                          <div className="wrapper lg-img">
                              <ParticleImage {...this.props.data.field_particles_image[36]}/>
                  ...
                  <Col sm={3}>
                      <ArticleTeaser classes="wrapper xtr-sm-img lg-img">
                          <ParticleImage {...this.props.data.field_particles_image[38]}/>
