            ...
            <div className='layout layout-picture-intensive'>
                <Container fluid classes='panel-1'>
                    ...
                    <Row>
                        ...
                        <Col md={4} className='article-meta-col'>
                            <div className='article-meta'>
                                ...
                                <ParticleText value={this.props.data.field_particles[0].value} classes={this.props.data.field_particles[0].classes}/>
                                <HR/>
                    ...
                    <Row className='big-row small-image'>
                        <Col sm={6}>
                            <ParticleImage url={this.props.data.field_particles[9].url} classes={this.props.data.field_particles[9].classes} credits={this.props.data.field_particles[9].credits}/>
                        </Col>
                        <Col sm={6}>
                    ...
                    <Row className='big-row'>
                        <Col sm={6} smOffset={3} mdOffset={2}>
                            <ParticleText value={this.props.data.field_particles[11].value} classes={this.props.data.field_particles[11].classes}/>
                        </Col>
                        <Col sm={4} md={3} className="pullquote-container">
                            <ParticlePullquote value={this.props.data.field_particles[12].value} classes={this.props.data.field_particles[12].classes}/>
                        </Col>
                    </Row>
                </Container>
            </div>
